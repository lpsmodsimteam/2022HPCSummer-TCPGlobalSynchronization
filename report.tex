...
\color{red} Average time difference between synchronization rate limits is now a metric, include graphs and edit section.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.50]{good-rate}
	\caption{ \color{red} CHANGE LINE TYPES Transmission rates of the three senders. Transmission rate limiting does not occur so global synchronization is not detected.}
	\label{fig:good-rate}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{good-metric}
...
\begin{figure}[H]
	...
	\caption{ \color{red} CHANGE LINE TYPES.Transmission rates of the three senders over time.}
	\label{fig:bad-rate}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{falpos-rate}
	\caption{\color{red} CHANGE LINE TYPES Simulation where all transmission rates are limited within a window of around 30 seconds}
	\label{fig:falpos-rate}
\end{figure}		

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{falpos-metric}
...
\color{red} THE IDEA BELOW IS NOW IMPLEMENTED, INCLUDE NEW GRAPHS AND CHANGE FUTURE WORK
\color{black}
