...
It would be useful to try increasing the fidelity of the simulation and comparing if the detection metric is still accurate. Examples include incorporating sliding window protocol, different queue dropping policies, and traffic prioritization.
