...
\begin{figure}[H]
	...
	\caption{Simulation where transmission rates are limited in a window of around thirty-thousand milliseconds.}
...
\begin{figure}[H]
	...
	\caption{A large window size (forty-thousand milliseconds) causes the metric to produce false-positives.}
